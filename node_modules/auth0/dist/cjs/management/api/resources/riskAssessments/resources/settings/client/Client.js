...
class SettingsClient {
    ...
    get newDevice() {
        var _a;
        return ((_a = this._newDevice) !== null && _a !== void 0 ? _a : (this._newDevice = new Client_js_1.NewDeviceClient(this._options)));
    }
    /**
    ...
    __get(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/risk-assessments/settings");
        });
    }
    /**
    ...
    __update(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "PATCH", "/risk-assessments/settings");
        });
    }
}
