...
const Client_js_2 = require("../resources/partials/client/Client.js");
const Client_js_3 = require("../resources/rendering/client/Client.js");
class PromptsClient {
    constructor(options) {
    ...
    get rendering() {
        var _a;
        return ((_a = this._rendering) !== null && _a !== void 0 ? _a : (this._rendering = new Client_js_3.RenderingClient(this._options)));
    }
    get customText() {
        var _a;
    ...
    get partials() {
        var _a;
        return ((_a = this._partials) !== null && _a !== void 0 ? _a : (this._partials = new Client_js_2.PartialsClient(this._options)));
    }
    /**
    ...
    __getSettings(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/prompts");
        });
    }
    /**
    ...
    __updateSettings() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "PATCH", "/prompts");
        });
    }
}
