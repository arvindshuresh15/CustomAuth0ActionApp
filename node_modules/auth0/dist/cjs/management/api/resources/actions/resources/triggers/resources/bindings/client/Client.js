        ...
        return __awaiter(this, arguments, void 0, function* (triggerId, request = {}, requestOptions) {
            const list = core.HttpResponsePromise.interceptFunction((request) => __awaiter(this, void 0, void 0, function* () {
                ...
                const _response = yield ((_d = this._options.fetcher) !== null && _d !== void 0 ? _d : core.fetcher)({
                    url: core.url.join((_f = (_e = (yield core.Supplier.get(this._options.baseUrl))) !== null && _e !== void 0 ? _e : (yield core.Supplier.get(this._options.environment))) !== null && _f !== void 0 ? _f : environments.ManagementEnvironment.Default, `actions/triggers/${core.url.encodePathParam(triggerId)}/bindings`),
                    method: "GET",
                    headers: _headers,
                ...
                return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/actions/triggers/{triggerId}/bindings");
            }));
            ...
            return new core.Page({
                ...
                hasNextPage: (response) => { var _a, _b; return ((_a = response === null || response === void 0 ? void 0 : response.bindings) !== null && _a !== void 0 ? _a : []).length >= Math.floor((_b = request === null || request === void 0 ? void 0 : request.per_page) !== null && _b !== void 0 ? _b : 50); },
    ...
    __updateMany(triggerId_1) {
        return __awaiter(this, arguments, void 0, function* (triggerId, request = {}, requestOptions) {
            ...
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.ManagementEnvironment.Default, `actions/triggers/${core.url.encodePathParam(triggerId)}/bindings`),
                method: "PATCH",
                headers: _headers,
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "PATCH", "/actions/triggers/{triggerId}/bindings");
        });
    }
}
exports.BindingsClient = BindingsClient;
