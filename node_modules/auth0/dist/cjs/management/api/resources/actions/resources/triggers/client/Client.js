...
class TriggersClient {
    ...
    get bindings() {
        var _a;
        return ((_a = this._bindings) !== null && _a !== void 0 ? _a : (this._bindings = new Client_js_1.BindingsClient(this._options)));
    }
    /**
    ...
    __list(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/actions/triggers");
        });
    }
}
