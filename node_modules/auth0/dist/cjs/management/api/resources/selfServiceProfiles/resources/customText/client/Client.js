...
class CustomTextClient {
    ...
    __list(id, language, page, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.ManagementEnvironment.Default, `self-service-profiles/${core.url.encodePathParam(id)}/custom-text/${core.url.encodePathParam(language)}/${core.url.encodePathParam(page)}`),
                method: "GET",
                headers: _headers,
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/self-service-profiles/{id}/custom-text/{language}/{page}");
        });
    }
    /**
    ...
    __set(id, language, page, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "PUT", "/self-service-profiles/{id}/custom-text/{language}/{page}");
        });
    }
}
