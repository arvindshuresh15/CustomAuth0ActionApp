...
const Client_js_1 = require("../resources/members/client/Client.js");
class GroupsClient {
    constructor(options) {
    ...
    get members() {
        var _a;
        return ((_a = this._members) !== null && _a !== void 0 ? _a : (this._members = new Client_js_1.MembersClient(this._options)));
    }
    /**
    ...
    list() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            const list = core.HttpResponsePromise.interceptFunction((request) => __awaiter(this, void 0, void 0, function* () {
                ...
                const { connection_id: connectionId, name, external_id: externalId, fields, include_fields: includeFields, from: from_, take = 50, } = request;
                const _queryParams = {};
                ...
                if (take !== undefined) {
                    _queryParams["take"] = (_b = take === null || take === void 0 ? void 0 : take.toString()) !== null && _b !== void 0 ? _b : null;
                }
                ...
                const _response = yield ((_d = this._options.fetcher) !== null && _d !== void 0 ? _d : core.fetcher)({
                    url: core.url.join((_f = (_e = (yield core.Supplier.get(this._options.baseUrl))) !== null && _e !== void 0 ? _e : (yield core.Supplier.get(this._options.environment))) !== null && _f !== void 0 ? _f : environments.ManagementEnvironment.Default, "groups"),
                    method: "GET",
                    headers: _headers,
                ...
                return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/groups");
            }));
    ...
    __get(id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_b = this._options.fetcher) !== null && _b !== void 0 ? _b : core.fetcher)({
                url: core.url.join((_d = (_c = (yield core.Supplier.get(this._options.baseUrl))) !== null && _c !== void 0 ? _c : (yield core.Supplier.get(this._options.environment))) !== null && _d !== void 0 ? _d : environments.ManagementEnvironment.Default, `groups/${core.url.encodePathParam(id)}`),
                method: "GET",
                headers: _headers,
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/groups/{id}");
        });
    }
}
