...
const Client_js_3 = require("../resources/themes/client/Client.js");
class BrandingClient {
    ...
    get themes() {
        var _a;
        return ((_a = this._themes) !== null && _a !== void 0 ? _a : (this._themes = new Client_js_3.ThemesClient(this._options)));
    }
    get phone() {
        var _a;
        return ((_a = this._phone) !== null && _a !== void 0 ? _a : (this._phone = new Client_js_1.PhoneClient(this._options)));
    }
    /**
    ...
    __get(requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "GET", "/branding");
        });
    }
    /**
    ...
    __update() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            return (0, handleNonStatusCodeError_js_1.handleNonStatusCodeError)(_response.error, _response.rawResponse, "PATCH", "/branding");
        });
    }
}
exports.BrandingClient = BrandingClient;
